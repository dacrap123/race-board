...
Audio files in `client/public/sounds/` override the generated audio when present. The included race-start clip is the first six seconds of `start.mp4`:

| File | Plays when |
|------|-----------|
| `start.mp4` | Race begins |
